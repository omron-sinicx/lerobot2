...
from lerobot.common.policies.diffusion.model.utils import DiffusionSinusoidalPosEmb
...
class PlainTransformer(ModuleAttrMixin):
    def __init__(self,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, PlainTransformer):
