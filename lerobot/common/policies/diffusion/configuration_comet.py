...
class CometConfig(PreTrainedConfig):
    ...
    Notes on the inputs and outputs:
        - "observation.state" is required as an input key. # TODO make it take multiple states 
        - Either:
    ...
    def get_output_sizes(self) -> list[int]:
        # TODO(malek) change to loop over input features
        return [v.shape[0] for k , v in self.action_features.items()] 
    
    @property
    def robot_state_features(self) -> dict[str, PolicyFeature]:
